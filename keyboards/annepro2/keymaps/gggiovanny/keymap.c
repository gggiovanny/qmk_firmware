...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    TD(TD_ALT_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, TD(TD_P_PSCR), TD(TD_LBRC_HOME), TD(TD_RBRC_END), KC_BSLS,
    TT(_FN1_LAYER), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, TD(TD_SCLN_BSPC), KC_QUOT, KC_ENT,
