...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CTL_TAB] = ACTION_TAP_DANCE_DOUBLE(KC_TAB, LCTL(KC_TAB)),
  ...
  [TD_SCLN_CLEFT] = ACTION_TAP_DANCE_DOUBLE(KC_SCLN, LCTL(KC_LEFT)),
  [TD_QUOT_CRIGHT] = ACTION_TAP_DANCE_DOUBLE(KC_QUOT, LCTL(KC_RIGHT)),
};
...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    TD(TD_CTL_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, TD(TD_P_PSCR), TD(TD_LBRC_HOME), TD(TD_RBRC_END), KC_BSLS,
    TT(_FN1_LAYER), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, TD(TD_SCLN_CLEFT), TD(TD_QUOT_CRIGHT), KC_ENT,
 ...
 [_GAME_LAYER] = KEYMAP( /* Game, no left hand tap dance */
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TAB, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_I, KC_TRNS, KC_P, KC_LBRC, KC_RBRC, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_J, KC_K, KC_L, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SLSH, KC_TRNS,
    KC_LCTL, KC_TRNS, KC_TRNS, KC_SPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_SPC), KC_TRNS, KC_TRNS, MO(_FN2_LAYER), KC_TRNS
),
  /*
  * Layer _FN2_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN2_LAYER] = KEYMAP( /* Base */
    ...
    KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, TG(_GAME_LAYER), KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN, KC_TRNS,
